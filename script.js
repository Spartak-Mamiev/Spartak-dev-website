    ...
    values.forEach(value => {
      ...
      <div class="project-card">
        <div class="project-description-container">
          ...
          <p class="project-description">${value.projectDescription}</p>
          <a href="${value.link}" target="_blank">View The Project</a>
        </div>
        <a href="${value.link}" target="_blank">
          <img class="project-screenshot" src="${value.image}" alt="${value.projectName} image" />
        </a>
      </div>`;
    });
  });
